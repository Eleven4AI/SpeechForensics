...
def load_args(default_config=None):
    ...
    parser.add_argument('--video-direc', default='/mnt/hdd4t/lyc/Dataset/lrs3', help='raw video directory')
    parser.add_argument('--landmark-direc', default='/mnt/hdd4t/lyc/Dataset/lrs3/landmark', help='landmark directory')
    parser.add_argument('--filename-path',default='/mnt/hdd4t/lyc/Dataset/lrs3/file.list',
                        help='list of detected video and its subject ID')
    parser.add_argument('--save-direc', default='/mnt/hdd4t/lyc/Dataset/lrs3/video', help='the directory of saving mouth ROIs')
    # -- mean face utils
    parser.add_argument('--mean-face', type=str,default='/mnt/hdd4t/lyc/python-pro/Talking-Face-Generation/av_hubert/avhubert/data/20words_mean_face.npy',
    ...
    parser.add_argument('--ffmpeg', type=str,default='/usr/bin/ffmpeg', help='ffmpeg path')
    parser.add_argument('--rank', type=int,default=0, help='rank id')
    parser.add_argument('--nshard', type=int,default=10, help='number of shards')
